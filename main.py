...
def main():
    argparser = argparse.ArgumentParser(
        description="export metatron scene from scene directory"
    )
    argparser.add_argument(
        "-s", "--scene", type=str, default="./", help="directory contains scene"
    )
    argparser.add_argument(
        "-o",
        "--output",
        type=str,
        default="./result/",
        help="directory to store the scene",
    )
    argparser.add_argument(
        "-r",
        "--renderer",
        ...
        choices=["tungsten"],
        default="tungsten",
        help="scene original renderer format",
    )
